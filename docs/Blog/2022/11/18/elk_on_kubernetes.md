...
```yaml linenums="1" title="docs/files/es-statefulset.yaml"
--8<--  "docs/files/es-statefulset.yaml"
```
...
```yaml linenums="1" title="docs/files/kibana-deployment.yaml"
--8<--  "docs/files/kibana-deployment.yaml"
```
